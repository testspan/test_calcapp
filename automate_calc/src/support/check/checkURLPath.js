 ...
 * @param  {String}   expectedPathLiteral   The expected path to match against
 */
export default (falseCase, expectedPathLiteral) => {
    const expectedPath = getLiteral(expectedPathLiteral);
